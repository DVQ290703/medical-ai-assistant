...
| **QĐ-BYT trên nguồn nhà nước khác** (*.gov.vn: SYT tỉnh, BV công, cục thuộc BYT; viendinhduong.vn) | PDF | **Văn bản hành chính nhà nước — KHÔNG bị bảo hộ** (Điều 15) | ✅ | CHỈ lấy file là Quyết định QĐ-BYT / HDĐT do Bộ Y tế ban hành (đăng lại). KHÔNG lấy tài liệu nội bộ BV / sách có bản quyền dù ở trên .gov.vn. `kb_fetch.py` host-guard: `*.gov.vn` + `*.kcb.vn` + `viendinhduong.vn`. QTKT (quy trình kỹ thuật) bỏ — không phải HDĐT. |
